...
class Ngrok_URL_Manager {
    ...
    public function admin_page_content() {
        ...
        if (isset($_POST['ngrok_url_submit']) && isset($_POST['ngrok_url'])) {
            ...
            echo '<div class="notice notice-success is-dismissible"><p>Ngrok URL saved successfully!</p></div>';
        ...
        ?>
        <div class="wrap">
            <h1>Ngrok Local URL Settings</h1>
            
            <div class="ngrok-container">
                <div class="card ngrok-card">
                    <div class="card-header bg-primary text-white">
                        <h2 class="card-title h5 mb-0">Configure Ngrok Tunnel URL</h2>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                        ...
                        <form method="post" action="">
                            ...
                            <div class="mb-3">
                                <label for="ngrok_url" class="form-label">Ngrok URL</label>
                            ...
                            <button type="submit" name="ngrok_url_submit" class="btn btn-primary">Save URL</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="card ngrok-card">
                    <div class="card-header bg-info text-white">
                        <h2 class="card-title h5 mb-0">Current Configuration</h2>
                    </div>
                    <div class="card-body">
                        <p><strong>WordPress Site URL:</strong> <?php echo site_url(); ?></p>
                        <p><strong>Current Ngrok URL:</strong> <?php echo $this->ngrok_url ? esc_html($this->ngrok_url) : '<em>Not set</em>'; ?></p>
                        <p><strong>WP Config Status:</strong> 
...
public function admin_page_content() {
    ...
    if (isset($_POST['ngrok_url_submit']) && isset($_POST['ngrok_url'])) {
        ...
        // Show success message
        echo '<div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert"><p>Ngrok URL saved successfully!</p></div>';
    ...
    <div class="wrap">
        ...
        <div class="ngrok-container">
            <div class="bg-white rounded-lg shadow-md overflow-hidden ngrok-card">
                ...
                <div class="p-6">
                    ...
                    <form method="post" action="">
                        <?php wp_nonce_field('save_ngrok_url', 'ngrok_url_nonce'); ?>
                        <div class="mb-4">
                            <label for="ngrok_url" class="block text-gray-700 text-sm font-bold mb-2">Ngrok URL</label>
                            <input type="url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="ngrok_url" name="ngrok_url" 
                                   value="<?php echo esc_attr($this->ngrok_url); ?>" placeholder="https://your-subdomain.ngrok-free.app" required>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden ngrok-card">
                <div class="bg-blue-400 text-white px-4 py-3">
                    <h2 class="text-lg font-medium mb-0">Current Configuration</h2>
                </div>
                <div class="p-6">
                    <p class="mb-2"><strong>WordPress Site URL:</strong> <?php echo site_url(); ?></p>
                    <p class="mb-2"><strong>Current Ngrok URL:</strong> <?php echo $this->ngrok_url ? esc_html($this->ngrok_url) : '<em>Not set</em>'; ?></p>
                    <p><strong>WP Config Status:</strong> 
                        <?php echo $this->check_wp_config_status() ? 'Ngrok constants found in wp-config.php' : 'No Ngrok constants in wp-config.php'; ?>
                    </p>
                </div>
